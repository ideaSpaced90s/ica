...
void main() {
  ...
  test('guided tutorial paths start at the selected level and end at chapter 34', () {
    ...
    expect(GuidedTutorialFlow.pathFor(GuidedTutorialLevel.basic).length, 34);
    ...
    expect(GuidedTutorialFlow.pathFor(GuidedTutorialLevel.intermediate).length, 25);
    ...
    expect(GuidedTutorialFlow.pathFor(GuidedTutorialLevel.advanced).length, 11);
  });
