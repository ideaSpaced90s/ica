...
class _HoloScanlineOverlayState extends State<HoloScanlineOverlay>
...
class HoloPixelDissolveEffect extends StatefulWidget {
  ...
  @override
  State<HoloPixelDissolveEffect> createState() =>
      _HoloPixelDissolveEffectState();
}

class _HoloPixelDissolveEffectState extends State<HoloPixelDissolveEffect>
    with SingleTickerProviderStateMixin {
...
class DissolvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    for (var p in particles) {
      ...
      canvas.drawRect(
        Rect.fromLTWH(currentPos.dx, currentPos.dy, p.size, p.size),
        paint,
      );
    }
  }
