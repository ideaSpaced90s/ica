...
class _GreaseTrailOverlayState extends State<GreaseTrailOverlay>
...
class _GreaseTrailPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint trailPaint = Paint()
      ...
      ..strokeWidth =
          20.0 *
          (1.0 + progress * 0.5) // Spreading effect
...
class _OilSplashEffectState extends State<OilSplashEffect>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
