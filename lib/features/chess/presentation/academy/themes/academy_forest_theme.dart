...
class AcademyForestTheme extends ChessTheme {
  const AcademyForestTheme() : super(id: 'theme2', name: 'Forest');

  @override
  Color get lightSquare => const Color(0xFFE6D3A3); // Sand/Cream

  @override
  Color get darkSquare => const Color(0xFF4F7942); // Forest Green
  ...
  @override
  Color get frameColor => const Color(0xFF2E4D23); // Darker Green Frame
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: isEnemy
              ? Colors.transparent
              : const Color(0xFF4F7942).withValues(alpha: 0.75),
          border: isEnemy
              ? Border.all(color: const Color(0xFF4F7942), width: 2.8)
              : null,
        ),
      ),
    );
  ...
  Widget buildLastMoveHighlight(BuildContext context, double opacity) {
    return Container(
      decoration: BoxDecoration(
        color: const Color(0xFFD4AF37).withValues(alpha: opacity), // Gold highlight
      ),
    );
  }
}
